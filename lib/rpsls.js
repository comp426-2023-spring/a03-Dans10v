export {rpsPlay, rpslsPlay}

//ROCK PAPER SCISSORS
function rpsPlay(playerAction){
        ...
        switch(playerAction.toLowerCase()){
            ...
            case 'paper':
                result = (ComputerAction === 'paper') ? 'tie' :
                         (ComputerAction === 'scissor') ? 'lose' : 'win';
                break;
            case 'scissor':
                result = (ComputerAction === 'scissor') ? 'tie' :
...
function rpslsPlay(playerAction){
    ...
    if(playerAction === undefined){
        ...
        switch(playerAction.toLowerCase()){
            ...
            case 'paper':
                result = (ComputerAction === 'paper') ? 'tie' :
                         (ComputerAction === 'scissor' || ComputerAction === 'lizard') ? 'lose' : 'win';
                break;
            case 'scissor':
                result = (ComputerAction === 'scissor') ? 'tie' :
